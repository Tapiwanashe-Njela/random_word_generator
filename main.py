...
row1.addWidget(title, alignment=Qt.AlignCenter) #add a wifget named title with alignment at the center 
...
#Drop them to the master layout; e.g rows and columns are layouts 
